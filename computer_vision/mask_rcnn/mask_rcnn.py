...
# 모델 & 설정 파일
model = 'mask_rcnn_backbone/frozen_inference_graph.pb'
config = 'mask_rcnn_backbone/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt'
class_labels = 'mask_rcnn_backbone/coco_90.names'
confThreshold = 0.6
maskThreshold = 0.3
